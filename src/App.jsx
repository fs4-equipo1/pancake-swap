    ...
    return (
      <div>
        ...
        <div className={styles.container}>
          ...
          <div>
            <Tipografia color={"--colors-warning"} texto={"Title Large"} isTitleLarge />
            <Tipografia color={"--colors-background"} texto={"Title"} isTitle />
            <Tipografia color={"--colors-textSubtle"} texto={"Subtitle large"} isSubtitleLarge />
            <Tipografia color={"--colors-textDisabled"} texto={"Subtitle"} isSubtitle />
            <Tipografia color={"--colors-failure"} texto={"Body Large"} isBodyLarge />
            <Tipografia color={"--colors-primary"} texto={"Body"} isBody />
  
            <div className={styles.textContainer}>
              <Tipografia color={"--colors-white"} texto={"Everyone's"} isTitleLarge />
              <div className={styles.subtext}>
                <Tipografia color={"--colors-secondary"} texto={"Favorite"} isTitleLarge />
