export const joinComunidadCardSwiper = [
    {
        ...
        subtitle:(
            <h4>PancakeSwap🥞Ev3ryone's Favourite D3X</h4>
        ),
        verificado:(
        ...
        texto:(
            <p>🐰💙PancakeSwap Fam, the moment is here!
            🥞Proposal to reduce the max supply of $CAKE from 750M to 450M!
            🌟By reducing our token supply by 300,000,000 $CAKE, we signify PancakeSwap’s successful shift from a high-inflation emissions model to the Ultrasound CAKE era.</p>
        ),
        enlace:(
            <a target="_blank" rel="noreferrer noopener" href="https://x.com/PancakeSwap/status/1740281555887825335?s=20" class="sc-hLclGa sc-dIEoRj btDlmQ dgoqDY">Web link 
            <svg viewBox="0 0 24 24" ml="3px" color="primary" width="20px" xmlns="http://www.w3.org/2000/svg" class="sc-grXZZQ hJcSUp">
